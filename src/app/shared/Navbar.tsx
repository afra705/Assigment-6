...
const Navbar = () => {
   ...
   <div className='border-b-2 sticky top-0 z-50 bg-black '>
        ...
        {/* part3 */}
            <div className='flex gap-2'>
                <button><Link className='' href='./plan'>Plan <span className='bg p-0.5 rounded-[50%] text-black'>{myPlan.length}</span></Link></button>
                <button><Link className='' href='./plan'>Saved {saved.length}</Link></button>
            </div>
       </nav>
   </div>
    );
